...
- Possibility to finish the matching (host will select which movie they will watch and it will end game)
- When the game ends, add an overview with statistics
