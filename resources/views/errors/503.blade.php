@extends('errors.layout', ['title' => '🍿 Intermission Time'])
...
@section('content')
    <section class="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <div class="animate-card-slide rounded-3xl border-2 border-amber-400/50 bg-gradient-to-br from-slate-800/95 to-slate-900/95 p-7 shadow-2xl shadow-amber-500/30 backdrop-blur-xl sm:p-8">
            ...
            <p class="mt-4 max-w-xl text-sm leading-relaxed text-purple-200/90 sm:text-base">
                The theater is resetting the lights for a quick intermission. Grab the popcorn and check back in a moment.
            </p>
            ...
            <div class="mt-6 flex flex-wrap items-center gap-3 text-xs text-purple-200/80">
                <span class="ticket-stub text-amber-200">Intermission Pass</span>
                <span class="ticket-stub text-purple-200">Doors Open Soon</span>
            </div>
        </div>
        ...
        <div class="animate-card-slide rounded-3xl border-2 border-purple-400/40 bg-gradient-to-br from-slate-800/90 to-slate-900/90 p-6 shadow-2xl shadow-purple-500/20 backdrop-blur-xl" style="animation-delay: 0.1s;">
            <div class="rounded-2xl border border-purple-400/40 bg-slate-950/60 p-6">
                <pre class="mb-5 rounded-xl border border-amber-400/30 bg-slate-950/70 p-4 text-center text-xs font-semibold text-amber-200/80">  _____  ____  ____ 
 | ____||  _ \|  _ \
 |  _|  | |_) | |_) |
 | |___ |  _ <|  _ <
 |_____||_| \_\_| \_\
 INTERMISSION
                ...
                <div class="flex items-center justify-between">
                    <div class="space-y-2">
                        <p class="text-xs uppercase tracking-[0.25em] text-purple-200/70">🎬 Now Showing</p>
                        <p class="text-lg font-bold text-amber-100">The Show Must Go On</p>
                    </div>
                ...
                <div class="mt-5 flex h-24 items-center justify-center rounded-xl border border-slate-700/70 bg-gradient-to-br from-slate-800 to-slate-900">
                    <div class="flex items-center gap-4">
                        <div class="animate-marquee-lights h-2 w-12 rounded-full bg-amber-400"></div>
                        <div class="animate-marquee-lights h-2 w-12 rounded-full bg-purple-400" style="animation-delay: 0.4s;"></div>
                        <div class="animate-marquee-lights h-2 w-12 rounded-full bg-amber-400" style="animation-delay: 0.8s;"></div>
                    </div>
                </div>
            </div>
            <div class="mt-6 grid gap-3 text-xs text-purple-200/80">
                ...
                <div class="flex items-center gap-3 rounded-xl border border-purple-400/30 bg-purple-500/10 p-3">
                    ...
                    Keep your ticket ready for showtime.
                </div>
            </div>
        </div>
    </section>
