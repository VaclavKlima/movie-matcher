@extends('errors.layout', ['title' => '⚠️ VIP Screening'])

@section('content')
    <section class="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
        <div class="animate-card-slide rounded-3xl border-2 border-purple-400/50 bg-gradient-to-br from-slate-800/95 to-slate-900/95 p-7 shadow-2xl shadow-purple-500/30 backdrop-blur-xl sm:p-8">
            <div class="inline-flex items-center gap-2 rounded-full border border-purple-400/50 bg-purple-500/20 px-4 py-1.5 text-[0.65rem] font-bold uppercase tracking-[0.2em] text-purple-100 sm:tracking-[0.3em]">
            ...
            <p class="mt-4 max-w-xl text-sm leading-relaxed text-purple-200/90 sm:text-base">
                This screening is VIP-only right now. Grab a ticket and we'll seat you before the doors close.
            </p>
            ...
            <div class="mt-6 flex flex-wrap items-center gap-3 text-xs text-purple-200/80">
                <span class="ticket-stub text-amber-200">Tickets Required</span>
                <span class="ticket-stub text-purple-200">Seats Reserved</span>
            </div>
        </div>

        <div class="animate-card-slide rounded-3xl border-2 border-amber-400/40 bg-gradient-to-br from-slate-800/90 to-slate-900/90 p-6 shadow-2xl shadow-amber-500/20 backdrop-blur-xl" style="animation-delay: 0.1s;">
            <div class="rounded-2xl border border-amber-400/40 bg-slate-950/60 p-6">
                <pre class="mb-5 rounded-xl border border-amber-400/30 bg-slate-950/70 p-4 text-center text-xs font-semibold text-amber-200/80">  _____   ___   ____ 
 |  ___| / _ \ |  _ \
 | |_   | | | || |_) |
 |  _|  | |_| ||  _ <
 |_|     \___/ |_| \_\
 VIP ONLY
                ...
                <div class="flex items-center justify-between">
                    <div class="space-y-2">
                        <p class="text-xs uppercase tracking-[0.25em] text-amber-200/70">🎫 VIP List</p>
                        <p class="text-lg font-bold text-amber-100">Reserved Screening</p>
                    </div>
                ...
                <div class="mt-5 flex h-28 items-center justify-center rounded-xl border border-slate-700/70 bg-gradient-to-br from-slate-800 to-slate-900">
                    <div class="grid grid-cols-3 gap-3">
                        <span class="cinema-seat h-8 w-8 bg-amber-400/40"></span>
                        <span class="cinema-seat h-8 w-8 bg-purple-400/40"></span>
                        <span class="cinema-seat h-8 w-8 bg-amber-400/40"></span>
                    </div>
                </div>
            </div>
            <div class="mt-6 grid gap-3 text-xs text-purple-200/80">
                ...
                <div class="flex items-center gap-3 rounded-xl border border-purple-400/30 bg-purple-500/10 p-3">
                    ...
                    Doors open once your ticket is ready.
                </div>
            </div>
        </div>
    </section>
